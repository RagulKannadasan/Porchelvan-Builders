              ...
              <div className="data-actions">
                <div className="data-card">
                  ...
                  <div className="data-info">
                    ...
                    <p className="text-muted" style={{ fontSize: '0.85rem', marginBottom: '1rem' }}>Download a complete JSON/CSV backup of your projects, budget, and inventory.</p>
                ...
                <div className="data-card">
                  ...
                  <div className="data-info">
                    ...
                    <p className="text-muted" style={{ fontSize: '0.85rem', marginBottom: '1rem' }}>Upload CSV records from your old software to populate the database.</p>
                    <button className="btn btn-outline btn-sm">Upload CSV</button>
                  </div>
                </div>
              </div>
            </div>
